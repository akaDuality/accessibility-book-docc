...
Но иногда элементы расположены в одну строку, и визуально они образуют группы, которые VoiceOver должен читать вместе. Представьте панель оценок в App Store: звёзды, количество оценок и возрастной рейтинг стоят в одну линию. Без группировки VoiceOver прочитает их в одну строку, перемешав данные из разных блоков.
