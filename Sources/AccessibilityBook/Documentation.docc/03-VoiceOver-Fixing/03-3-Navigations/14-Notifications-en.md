...
## .pageScrolled
iOS sends this notification after a scroll, to tell about elements that have appeared. For describing a table, the text from the `accessibilityScrollStatus(for:)` method is used. Example in the chapter <doc:15-Scroll-en>
