...
Заголовки — один из основных способов навигации через <doc:13-Rotor>. Пользователь переключает ротор в режим «Заголовки» и вертикальными свайпами перемещается от заголовка к заголовку, быстро изучая структуру экрана.
