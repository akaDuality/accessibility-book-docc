...
- создать ротор, присвоить его свойству
customRotors,
- дать название для ротора и функцию, что
обработает результат,
- написать эту функцию. Она определит, какой
следующий элемент должен попасть в фокус.
