...
If with a vertical swipe you're changing the size of a drink, pizza, or clothing, then along with the size the price may also change. In such a case, you need to send a notification that will additionally announce the price change. More on this later in the chapter <doc:14-Notifications-en>.
