...
Headings are one of the main ways of navigating through the <doc:13-Rotor>. The user switches the rotor to "Headings" mode and with vertical swipes moves from heading to heading, quickly examining the screen's structure.
